...
/**
 * REST controller for managing {@link fr.delpharm.esacp.domain.TypeRapport}.
 */
@RestController
@RequestMapping("/api")
public class TypeRapportResource {
    ...
    private static final String ENTITY_NAME = "typeRapport";
     ...
     * @throws URISyntaxException if the Location URI syntax is incorrect.
     */
    @PatchMapping(value = "/type-rapports/{id}", consumes = "application/merge-patch+json")
     ...
     */
    @GetMapping("/type-rapports")
    public ResponseEntity<List<TypeRapportDTO>> getAllTypeRapports(Pageable pageable) {
     ...
     */
    @GetMapping("/type-rapports/{id}")
    public ResponseEntity<TypeRapportDTO> getTypeRapport(@PathVariable Long id) {
     ...
     */
    @DeleteMapping("/type-rapports/{id}")
    public ResponseEntity<Void> deleteTypeRapport(@PathVariable Long id) {
