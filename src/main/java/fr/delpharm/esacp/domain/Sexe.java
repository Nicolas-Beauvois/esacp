...
public class Sexe implements Serializable {
    ...
    public Sexe userExtras(Set<UserExtra> userExtras) {
        this.setUserExtras(userExtras);
        return this;
    }

    public Sexe addUserExtra(UserExtra userExtra) {
        this.userExtras.add(userExtra);
        userExtra.setSexe(this);
        return this;
    }

    public Sexe removeUserExtra(UserExtra userExtra) {
        this.userExtras.remove(userExtra);
        userExtra.setSexe(null);
        return this;
    }

    public void setUserExtras(Set<UserExtra> userExtras) {
        if (this.userExtras != null) {
            this.userExtras.forEach(i -> i.setSexe(null));
        }
        if (userExtras != null) {
            userExtras.forEach(i -> i.setSexe(this));
        }
