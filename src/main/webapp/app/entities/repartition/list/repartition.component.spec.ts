...
describe('Component Tests', () => {
  describe('Repartition Management Component', () => {
    let comp: RepartitionComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(RepartitionComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.repartitions?.[0]).toEqual(expect.objectContaining({ id: 123 }));
    });
