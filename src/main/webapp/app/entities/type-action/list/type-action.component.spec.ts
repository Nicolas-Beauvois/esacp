...
describe('Component Tests', () => {
  describe('TypeAction Management Component', () => {
    let comp: TypeActionComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(TypeActionComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.typeActions?.[0]).toEqual(expect.objectContaining({ id: 123 }));
    });
