...
describe('Component Tests', () => {
  describe('Priorite Management Component', () => {
    let comp: PrioriteComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(PrioriteComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.priorites?.[0]).toEqual(expect.objectContaining({ id: 123 }));
    });
