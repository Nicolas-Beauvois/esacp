...
describe('Component Tests', () => {
  describe('EtapeValidation Management Component', () => {
    let comp: EtapeValidationComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(EtapeValidationComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.etapeValidations?.[0]).toEqual(expect.objectContaining({ id: 123 }));
    });
