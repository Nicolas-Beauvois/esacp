...
class DepartementResourceIT {
    ...
    public static Departement createEntity(EntityManager em) {
        Departement departement = new Departement().departement(DEFAULT_DEPARTEMENT).typeService(DEFAULT_TYPE_SERVICE);
        return departement;
    }
    ...
    public static Departement createUpdatedEntity(EntityManager em) {
        Departement departement = new Departement().departement(UPDATED_DEPARTEMENT).typeService(UPDATED_TYPE_SERVICE);
        return departement;
    }
    ...
    void createDepartement() throws Exception {
        ...
        assertThat(testDepartement.getDepartement()).isEqualTo(DEFAULT_DEPARTEMENT);
        assertThat(testDepartement.getTypeService()).isEqualTo(DEFAULT_TYPE_SERVICE);
    }
    ...
    void putNewDepartement() throws Exception {
        ...
        updatedDepartement.departement(UPDATED_DEPARTEMENT).typeService(UPDATED_TYPE_SERVICE);
        ...
        Departement testDepartement = departementList.get(departementList.size() - 1);
        assertThat(testDepartement.getDepartement()).isEqualTo(UPDATED_DEPARTEMENT);
        assertThat(testDepartement.getTypeService()).isEqualTo(UPDATED_TYPE_SERVICE);
    }
    ...
    void partialUpdateDepartementWithPatch() throws Exception {
        ...
        partialUpdatedDepartement.departement(UPDATED_DEPARTEMENT).typeService(UPDATED_TYPE_SERVICE);
